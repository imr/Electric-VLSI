...
public final class MenuCommands {
	...
	private static EMenu wiringShortcuts() {
		return new EMenu("Shortcuts",
				...
				// new EMenuItem("Set M1 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_1, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(1); }},
				// new EMenuItem("Set M2 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_2, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(2); }},
				// new EMenuItem("Set M3 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_3, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(3); }},
				// new EMenuItem("Set M4 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_4, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(4); }},
				// new EMenuItem("Set M5 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_5, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(5); }},
				// new EMenuItem("Set M6 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_6, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(6); }},
				// new EMenuItem("Set M7 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_7, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(7); }},
				// new EMenuItem("Set M8 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_8, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(8); }},
				// new EMenuItem("Set M9 Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_9, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(9); }},
				// new EMenuItem("Set All Visible",
				// KeyStroke.getKeyStroke(KeyEvent.VK_0, InputEvent.SHIFT_MASK))
				// { public void run() {
				// setLayerVisible(0); }},
				// EMenuItem.SEPARATOR,
