...
public class StatusBar extends JPanel implements HighlightListener, DatabaseChangeListener {
     ...
     * 
     * @param highlighterGainedFocus
     *            the highlighter for the current window (may be null).
     */
    ...
    private void redoStatusBar() {
        ...
        // FontMetrics fm =
        // this.getGraphics().getFontMetrics(fieldSelected.getFont());
        // int a = SwingUtilities.computeStringWidth(fm,
    ...
    private String addLayerInfo(PortProto pp) {
        // if the port is on a generic primitive which can connect to
        // everything, say so
