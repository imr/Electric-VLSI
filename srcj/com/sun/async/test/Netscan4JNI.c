...
#include "com_sun_async_test_Netscan4JNI.h"
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1Connect
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1hard_1reset
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1set_1scan_1clk
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1set_1trst
  (JNIEnv *env, jclass cls, jint signal)
{
    return NetUSB_set_trst(signal);
}

JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1Disconnect
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1tms_1reset
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1move_1to_1state
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1scan_1ir
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1scan_1dr
  (JNIEnv *env, jclass cls, jshortArray scanIn, jlong bitLength, jshortArray scanOut, jint tap)
{
    //variable preparation phase
    jshort *scanInP = (*env)->GetShortArrayElements(env, scanIn, 0);
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_Netscan4JNI_netUSB_1AccessScanGPIO
