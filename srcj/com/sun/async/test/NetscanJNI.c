...
#include "com_sun_async_test_NetscanJNI.h"
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1connect
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1configure
  (JNIEnv *env, jclass cls, jlong kHz, jshort stop_state, jint mV)
{
  return Net_Configure(kHz, stop_state, mV);
}

JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1set_1trst
  (JNIEnv *env, jclass cls, jint signal)
{
  return Net_Set_TRST(signal);
}

JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1disconnect
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1tms_1reset
  (JNIEnv *env, jclass cls)
{
    int result;
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1move_1to_1state
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1scan_1ir
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1scan_1dr
  (JNIEnv *env, jclass cls, jshortArray scanIn, jlong bitLength, jshortArray scanOut)
{
    //variable preparation phase
    jshort *scanInP = (*env)->GetShortArrayElements(env, scanIn, 0);
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_NetscanJNI_net_1set_1parallel_1io
