...
#include "com_sun_async_test_GPIB.h"
#include "ugpib.h"
...
*/
JNIEXPORT jint JNICALL Java_com_sun_async_test_GPIB_ibwrt
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_GPIB_ibrd
  (JNIEnv *penv, jclass cls, jint ud, jbyteArray data, jint length, jintArray err)
{
  unsigned int ret;
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_GPIB_ibfind
...
JNIEXPORT jint JNICALL Java_com_sun_async_test_GPIB_ibask
...
/*
 * Class:     com_sun_async_test_GPIB
 * Method:    ibclr
 * Signature: (I[I)I
 */
JNIEXPORT jint JNICALL Java_com_sun_async_test_GPIB_ibclr
 ...
 * Signature: (I[BJ[I)I
 */
JNIEXPORT jint JNICALL Java_com_sun_async_test_GPIB_ibcmd
