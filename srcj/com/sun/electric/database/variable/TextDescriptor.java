...
public class TextDescriptor
{
	...
	public Position TDGetPos(TextDescriptor td) { return thePositions[td.descriptor0 & VTPOSITION]; }
	/** routine to set the text position of the text descriptor. */
	public void TDSetPos(TextDescriptor td, Position p) {td.descriptor0 = (td.descriptor0 & ~VTPOSITION) | p.getIndex(); }

	/** routine to return the text size of the text descriptor. */
	public int TDGetSize(TextDescriptor td) { return (td.descriptor1 & VTSIZE) >> VTSIZESH; }
	/** routine to set the text size of the text descriptor. */
	public void TDSetSize(TextDescriptor td, int v) {td.descriptor1 = (td.descriptor1 & ~VTSIZE) | (v << VTSIZESH); }

	/** routine to return the text font of the text descriptor. */
	public int TDGetFace(TextDescriptor td) { return (td.descriptor1 & VTFACE) >> VTFACESH; }
	/** routine to set the text font of the text descriptor. */
	public void TDSetFace(TextDescriptor td, int v) {td.descriptor1 = (td.descriptor1 & ~VTFACE) | (v << VTFACESH); }

	/** routine to return the text rotation of the text descriptor. */
	public int TDGetRotation(TextDescriptor td) { return (td.descriptor1 & VTROTATION) >> VTROTATIONSH; }
	/** routine to set the text rotation of the text descriptor. */
	public void TDSetRotation(TextDescriptor td, int v) {td.descriptor1 = (td.descriptor1 & ~VTROTATION) | (v << VTROTATIONSH); }

	/** routine to return the text display part of the text descriptor. */
	public DispPos TDGetDispPart(TextDescriptor td) { return theDispPos[td.descriptor0 & VTDISPLAYPART]; }
	/** routine to set the text display part of the text descriptor. */
	public void TDSetDispPart(TextDescriptor td, DispPos v) {td.descriptor0 = (td.descriptor0 & ~VTDISPLAYPART) | v.getIndex(); }

	/** routine to return true if the text descriptor indicates italic text. */
	public boolean TDGetItalic(TextDescriptor td) { return (td.descriptor0 & VTITALIC) != 0; }
	/** routine to set the text descriptor's italic text factor. */
	public void TDSetItalic(TextDescriptor td, boolean i) {td.descriptor0 = (td.descriptor0 & ~VTITALIC) | (i ? VTITALIC : 0); }

	/** routine to return true if the text descriptor indicates bold text. */
	public boolean TDGetBold(TextDescriptor td) { return (td.descriptor0 & VTBOLD) != 0; }
	/** routine to set the text descriptor's bold text factor. */
	public void TDSetBold(TextDescriptor td, boolean b) {td.descriptor0 = (td.descriptor0 & ~VTBOLD) | (b ? VTBOLD : 0); }

	/** routine to return true if the text descriptor indicates underlined text. */
	public boolean TDGetUnderline(TextDescriptor td) { return (td.descriptor0 & VTUNDERLINE) != 0; }
	/** routine to set the text descriptor's underlined text factor. */
	public void TDSetUnderline(TextDescriptor td, boolean u) {td.descriptor0 = (td.descriptor0 & ~VTUNDERLINE) | (u ? VTUNDERLINE : 0); }

	/** routine to return true if the text descriptor indicates interior text (not see at higher-levels of hierarchy). */
	public boolean TDGetInterior(TextDescriptor td) { return (td.descriptor0 & VTINTERIOR) != 0; }
	/** routine to set the text descriptor's interior text factor (whether seen at higher-levels of hierarchy). */
	public void TDSetInterior(TextDescriptor td, boolean i) {td.descriptor0 = (td.descriptor0 & ~VTINTERIOR) | (i ? VTINTERIOR : 0); }

	/** routine to return true if the text descriptor indicates inheritable text (instances copy from prototypes). */
	public boolean TDGetInherit(TextDescriptor td) { return (td.descriptor0 & VTINHERIT) != 0; }
	/** routine to set the text descriptor's inheritable text factor (whether instances copy from prototypes). */
	public void TDSetInherit(TextDescriptor td, boolean i) {td.descriptor0 = (td.descriptor0 & ~VTINHERIT) | (i ? VTINHERIT : 0); }

	/** routine to return true if the text descriptor indicates that this variable is a cell parameter. */
	public boolean TDGetIsParam(TextDescriptor td) { return (td.descriptor0 & VTISPARAMETER) != 0; }
	/** routine to set the text descriptor's parameter factor. */
	public void TDSetIsParam(TextDescriptor td, boolean i) {td.descriptor0 = (td.descriptor0 & ~VTISPARAMETER) | (i ? VTISPARAMETER : 0); }

	/** routine to return the X offset of the text in the text descriptor. */
	public int TDGetXOff(TextDescriptor td)
	{
		int offset = (td.descriptor0 & VTXOFF) >> VTXOFFSH;
		if ((td.descriptor0&VTXOFFNEG) != 0) offset = -offset;
		int scale = TDGetOffScale(td) + 1;
		return(offset * scale);
	}
	/** routine to return the X offset of the text in the text descriptor. */
	public int TDGetYOff(TextDescriptor td)
	{
		int offset = (td.descriptor0 & VTYOFF) >> VTYOFFSH;
		if ((td.descriptor0&VTYOFFNEG) != 0) offset = -offset;
		int scale = TDGetOffScale(td) + 1;
		return(offset * scale);
	}
	/** routine to set the X and Y offset of the text in the text descriptor. */
	public void TDSetOff(TextDescriptor td, int x, int y)
	{
		td.descriptor0 = td.descriptor0 & ~(VTXOFF|VTYOFF|VTXOFFNEG|VTYOFFNEG);
		if (x < 0)
		{
			x = -x;
			td.descriptor0 |= VTXOFFNEG;
		}
		if (y < 0)
		{
			y = -y;
			td.descriptor0 |= VTYOFFNEG;
		}
		int scale = Math.max(x,y) >> VTOFFMASKWID;
		x /= (scale + 1);
		y /= (scale + 1);
		td.descriptor0 |= (x << VTXOFFSH);
		td.descriptor0 |= (y << VTYOFFSH);
		TDSetOffScale(td, scale);
	}

	/** routine to return the offset scale of the text in the text descriptor. */
	public int TDGetOffScale(TextDescriptor td) { return (td.descriptor1 & VTOFFSCALE) >> VTOFFSCALE; }
	/** routine to set the offset scale of the text in the text descriptor. */
	public void TDSetOffScale(TextDescriptor td, int v) {td.descriptor1 = (td.descriptor1 & ~VTOFFSCALE) | (v << VTOFFSCALESH); }

	/** routine to return the units of the text in the text descriptor. */
	public Units TDGetUnits(TextDescriptor td) { return theUnits[(td.descriptor1 & VTUNITS) >> VTUNITSSH]; }
	/** routine to set the units of the text in the text descriptor. */
	public void TDSetUnits(TextDescriptor td, Units v) {td.descriptor1 = (td.descriptor1 & ~VTUNITS) | (v.getIndex() << VTUNITSSH); }
}
