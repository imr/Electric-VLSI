...
//		protoPortBeg[ind] = beg;
	...
	int getPortOffset(int iconIndex, int portIndex, int busIndex) {
		...
		int portOffset = portOffsets[portInd] + busIndex;
		if (busIndex < 0 || portOffset >= portOffsets[portInd+1]) return -1;
