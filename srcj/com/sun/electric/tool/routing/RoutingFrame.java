...
public class RoutingFrame {
	...
	// new RoutingFrameSample(),
			...
			new com.sun.electric.tool.routing.experimentalAStar1.AStarRoutingFrame(), // Team
																						// 1
			new com.sun.electric.tool.routing.experimentalAStar2.AStarRouter(), // Team
																				// 3v2
			new com.sun.electric.tool.routing.experimentalAStar3.AStarRouter(), // Team
																				// 3v1
			new com.sun.electric.tool.routing.experimentalLeeMoore1.yana(), // Team
																			// 6
			new com.sun.electric.tool.routing.experimentalLeeMoore2.RoutingFrameLeeMoore(), // Team
																							// 4
			new com.sun.electric.tool.routing.experimentalLeeMoore3.RoutingFrameLeeMoore(), // Team
																							// 2
	};
	...
	public class RoutingParameter {
		 ...
		 * 
		 * @param name
		 *            the parameter name (should be simple, no spaces).
		 * @param title
		 *            the title of the parameter (used in the Preferences
		 *            dialog).
		 * @param factory
	...
	public static class RoutingLayer {
		 ...
		 * 
		 * @param layer
		 *            the Electric Layer associated with this RoutingLayer.
		 * @param ap
		 ...
		 * @param maxSurround
		 *            the maximum DRC rule around this RoutingLayer.
		 */
		 ...
		 * 
		 * @return the proper RoutingContact to use when joining two of these
		 *         layers.
		 */
	...
	public static class RoutingGeometry {
		 ...
		 * 
		 * @param layer
		 *            the RoutingLayer on which this RoutingGeometry resides.
		 * @param bounds
		 *            the shape of this RoutingGeometry.
		 * @param netID
		 *            the global network number of this RoutingGeometry.
		 */
	...
	public static class RoutingContact {
		 ...
		 * 
		 * @param np
		 *            the PrimitiveNode associated with this RoutingContact.
		 * @param layers
		 *            the geometry that composes this RoutingContact.
		 * @param first
		 *            the first layer that this RoutingContact connects.
		 * @param second
		 *            the second layer that this RoutingContact connects.
		 * @param viaSpacing
		 *            the center-to-center minimum spacing of the vias in this
		 *            RoutingContact.
		 */
		...
		/**
		 * Method to return the name of this RoutingContact. This is useful for
		 * debugging.
		 * 
		 ...
		 * 
		 * @return a List of pieces of RoutingGeometry that compose this
		 *         RoutingContact.
		 */
	...
	public static class RoutingEnd {
		 ...
		 * 
		 * @param pi
		 *            the Electric PortInst that is at this end of the route.
		 */
	...
	public static class RoutingSegment {
		...
		/**
		 * Method to return the name of this RoutingSegment. This is for
		 * debugging.
		 * 
		 ...
		 * 
		 * @param rw
		 *            a wire segment that is part of the final route.
		 */
	...
	public static class RouteWire {
		 ...
		 * 
		 * @param layer
		 *            the RoutingLayer on which this wire resides.
		 * @param start
		 *            a RoutePoint that defines the start of the wire.
		 * @param end
		 *            a RoutePoint that defines the finish of the wire.
		 * @param width
	...
	public static class RoutePoint {
		 ...
		 *            the RoutingSegment, use RoutingContact.STARTPOINT and
		 *            RoutingContact.FINISHPOINT.
		 * @param loc
		 *            the coordinates of this RoutePoint.
		 * @param angle
		 *            the rotation of the RoutingContact (in degrees).
		 */
		...
		/**
		 * Method to return the RoutingContact that is to be placed at this
		 * RoutePoint.
		 * 
	...
	public int doRouting(Cell cell) {
		...
		for (RoutingSegment rs : segmentsToRoute) {
			...
			if (contacts.size() == 0 && wires.size() == 0)
				continue;
