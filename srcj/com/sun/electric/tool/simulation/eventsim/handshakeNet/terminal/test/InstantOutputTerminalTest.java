...
import com.sun.electric.tool.simulation.eventsim.handshakeNet.terminal.InstantOutputTerminal;
import com.sun.electric.tool.simulation.eventsim.handshakeNet.terminal.OutputTerminal;

import static org.junit.Assert.assertEquals;

public class InstantOutputTerminalTest {
	...
	OutputTerminalTestSource source;
	OutputTerminalTestDestination destination;
	...
	public void setUp() throws Exception {
		// make the pieces
		source= new OutputTerminalTestSource("OutputTerminalTestSource");
		destination= new OutputTerminalTestDestination("OutputTerminalTestDestination");
		outTerm= new InstantOutputTerminal("InstantOutputTerminalUnderTest");

		source.setData(testData);
		source.setNumOutputs(numOutputs);
		source.setTerminal(outTerm);
		
		destination.setTerminal(outTerm);
...
} // class InstantOutputTerminalTest
