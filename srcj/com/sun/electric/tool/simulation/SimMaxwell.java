...
{	
	...
	public class Maxwell extends Job
	{
		...
		protected Maxwell(NodeProto np)
		{
	...
	//		}
			...
			while(niIt.hasNext())
			{
				...
				if(ni.getProto().getTechnology().isNoPrimitiveNodes()==false)
				{
					...
					Cell.rebuildAllNetworks(null);		
					Iterator it = ni.getProto().getNetworks();
