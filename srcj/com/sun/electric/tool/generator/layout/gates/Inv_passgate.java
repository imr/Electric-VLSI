...
public class Inv_passgate {
	...
	public static Cell makePart(double sz, StdCellParams stdCell) {
		...
		TrackRouter gnd = new TrackRouterH(tech.m2(), stdCell.getGndWidth(), tech, inv);
		...
		TrackRouter invOutHi = new TrackRouterH(tech.m2(), 4, outHiY, tech, inv);
		invOutHi.connect(invOut);
		for (int i=1; i<pmos.nbSrcDrns(); i+=2) {
			invOutHi.connect(pmos.getSrcDrn(i));
		}
		TrackRouter invOutLo = new TrackRouterH(tech.m2(), 4, outLoY, tech, inv);
		...
		TrackRouter outLo = new TrackRouterH(tech.m1(), 3, outM1Y, tech, inv);
		...
		TrackRouter outHi = new TrackRouterH(tech.m2(), 3, outLoY, tech, inv);
		outHi.connect(jog);
		...
		LayoutLib.newExport(inv, "en", PortCharacteristic.IN, tech.m1(), 4,
							enX, enY);
		TrackRouter en = new TrackRouterH(tech.m1(), 3, enY, tech, inv);
