...
public class Nms2_sy {
    ...
    LayoutLib.newExport(nms2, "g", PortProto.Characteristic.IN, Tech.m1, 4,
						gX, gY);
    ...
    LayoutLib.newExport(nms2, "g2", PortProto.Characteristic.IN, Tech.m1, 4,
						g2X, g2Y);
    // output d  m1_wid/2 + m1_m1_sp + m1_wid/2
    double dX = g2X + 2 + 3 + 2;
    LayoutLib.newExport(nms2, "d", PortProto.Characteristic.OUT, Tech.m1, 4,
						dX, dY);
