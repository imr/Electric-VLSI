 ...
 * 
 * <p>
 * The extendig class may override getProgress(), which returns a string
...
public abstract class Job implements Serializable {
	...
	/**
	 * Check if we are scheduled to abort. If so, print msg if non null and
	 ...
	 *         aborted. and it will report it to std output
	 */
