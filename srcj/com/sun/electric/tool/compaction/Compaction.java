...
import com.sun.electric.tool.routing.Routing.Activity;
...
//						// check the distance
//						double this_motion = com_check(nlayer, nindex, object, xl, xh, yl,
...
//						((INTBIG)cur_object->inst.ai, VARCINST, CHANGETYPEREMOVETEMP, 0);
				}
			}
		}
		for(LINE cur_line = nfixline; cur_line != null; cur_line = cur_line.nextline)
...
//						((INTBIG)cur_object->inst.ai, VARCINST, CHANGETYPEREMOVETEMP, 0);
	 ...
	 * line will not slide.
	 */
	private void com_noslide(LINE line)
	{
...
//					ai->userbits |= CANTSLIDE;
	 ...
	 */
	private void com_slide(LINE line)
	{
		for(LINE cur_line = line; cur_line != null; cur_line = cur_line.nextline)
		{
			for(OBJECT cur_object = cur_line.firstobject; cur_object != null; cur_object = cur_object.nextobject)
			{
				...
				{
					ArcInst ai = (ArcInst)cur_object.inst;
//					ai->userbits = (ai->userbits & ~CANTSLIDE) | (ai->temp2&CANTSLIDE);
				}
			}
		}
	}
