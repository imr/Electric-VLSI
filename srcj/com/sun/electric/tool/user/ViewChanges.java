...
public class ViewChanges
{
	...
	private static class MakeSkeletonView extends Job
	{
		...
		public boolean doIt() throws JobException
		{
			...
			boolean error = skeletonizeCell(curCell, skeletonCell, iconParameters);
	 ...
	 */
	public static boolean skeletonizeCell(Cell curCell, Cell skeletonCell, IconParameters iconParameters)
	{
	...
	private static class MakeSchematicView extends Job
	{
		...
		public boolean doIt() throws JobException
		{
			newCell = convertSchematicCell(oldCell, iconParameters);
	...
	private static Cell convertSchematicCell(Cell oldCell, IconParameters iconParameters)
	{
		...
		buildSchematicNodes(oldCell, newCell, newNodes, iconParameters);
                                            ...
                                            IconParameters iconParameters)
	{
		...
		for(Iterator<NodeInst> it = cell.getNodes(); it.hasNext(); )
		{
			...
			} else if (type == null)
			{
				...
				if (equivCell == null)
					equivCell = convertSchematicCell(proto, iconParameters);
