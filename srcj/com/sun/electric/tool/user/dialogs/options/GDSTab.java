...
public class GDSTab extends PreferencePanel
{
    ...
    private Setting layoutTechSetting = IOTool.getGDSLayoutTechnology();
	...
	public void init()
	{
        ...
        // Layout technology for import GDS
        importTechSelection.removeAllItems();
        Technology layTech = Technology.findTechnology(getString(layoutTechSetting));
        for(Iterator<Technology> it = Technology.getTechnologies(); it.hasNext(); )
		{
			Technology tech = it.next();
            if (tech.isLayout())
            {
                ...
                importTechSelection.addItem(t);
                if (layTech == tech)
                    importTechSelection.setSelectedItem(t);
            }
        }
    }
	...
	public void term()
	{
        ...
        setString(layoutTechSetting, importTechSelection.getSelectedItem().toString());
    }
    ...
    private void initComponents() {
        ...
        importTechSelection = new javax.swing.JComboBox();
        ...
        preferences.add(gdsInputMergesBoxes, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 2, 4);
        preferences.add(gdsInputIncludesText, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 2, 4);
        preferences.add(gdsInputExpandsCells, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 2, 4);
        preferences.add(gdsInputInstantiatesArrays, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 2, 4);
        preferences.add(gdsSimplifyCells, gridBagConstraints);
        ...
        preferences.add(gdsArraySimplification, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(0, 2, 0, 4);
        preferences.add(gdsUnknownLayers, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 2, 4);
        preferences.add(gdsColapseNames, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 2, 4);
        preferences.add(gdsConvertNCCExportsConnectedByParentPins, gridBagConstraints);
        ...
        jLabel14.setText("Layout technoloy:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        importTechSelection.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 2, 4);
        inputPanel.add(importTechSelection, gridBagConstraints);
...
// TODO add your handling code here:
    ...
    private javax.swing.JComboBox importTechSelection;
