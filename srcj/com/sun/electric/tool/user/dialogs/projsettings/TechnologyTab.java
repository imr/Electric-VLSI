...
public class TechnologyTab extends ProjSettingsPanel
{
	...
	public TechnologyTab(ProjectSettingsFrame parent, boolean modal)
	{
		super(parent, modal);
		initComponents();
	    EDialog.makeTextFieldSelectAllOnTab(techSchemNegBubbleSize);
	}
	...
	public void init()
	{
		...
		// Schematics
		techSchemNegBubbleSize.setText(TextUtils.formatDouble(Schematics.tech().getNegatingBubbleSize()));
...
//			System.out.println("Exceptions while importing extra technologies");
	...
	public void term()
	{
		...
		// Schematics
		double currentNegatingBubbleSize = TextUtils.atof(techSchemNegBubbleSize.getText());
...
//			Schematics.tech().setNegatingBubbleSize(currentNegatingBubbleSize);
    ...
    private void initComponents() {
        ...
        techSchemNegBubbleSize = new javax.swing.JTextField();
        ...
        jLabel1.setText("Negating bubble size:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 4, 4);
        schematicsPanel.add(jLabel1, gridBagConstraints);

        techSchemNegBubbleSize.setColumns(8);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(2, 4, 4, 4);
        schematicsPanel.add(techSchemNegBubbleSize, gridBagConstraints);
    ...
    private javax.swing.JTextField techSchemNegBubbleSize;
