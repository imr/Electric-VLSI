...
public final class UserInitial
{
    ...
    /** Please don't delete this, this is used for testing */
    public static class MakeFake extends Job
    {
        public MakeFake() {
        ...
        public void doIt()
        {
			...
			Library mainLib = Library.newInstance("fake", null);
...
NodeInst rotTrans = NodeInst.newInstance(nTransProto, new Point2D.Double(0.0, 10.0), nTransProto.getDefWidth(), nTransProto.getDefHeight(), 3150, myCell, "rotated");
			...
			Variable var = nodeLabel.newVar("ART_message", "Rotated 0");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 90");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 180");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 270");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 0 MX");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 90 MX");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 180 MX");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 270 MX");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 0 MY");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 90 MY");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 180 MY");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 270 MY");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 0 MXY");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 90 MXY");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 180 MXY");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			var = nodeLabel.newVar("ART_message", "Rotated 270 MXY");
			var.setDisplay();	var.getTextDescriptor().setRelSize(10); var.setDescriptor(var.getTextDescriptor());
			...
			for(int y=0; y<arraySize; y++)
			{
				for(int x=0; x<arraySize; x++)
				{
					...
					instanceNode.getNameTextDescriptor().setOff(0, 32);
					instanceNode.setNameTextDescriptor(instanceNode.getNameTextDescriptor());
