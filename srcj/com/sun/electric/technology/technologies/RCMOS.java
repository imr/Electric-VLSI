...
public class RCMOS extends Technology
{
	...
	private RCMOS()
	{
		...
		Layer metal2_lay = Layer.newInstance(this, "Metal-2",
			new EGraphics(EGraphics.SOLID, EGraphics.PATTERNED, EGraphics.TRANSPARENT_5, 224,95,255,0.8,1,
			new int[] { 0x1010,   //    X       X   
						0x2020,   //   X       X    
						0x4040,   //  X       X     
						0x8080,   // X       X      
		...
		Layer polysilicon_lay = Layer.newInstance(this, "Polysilicon",
			new EGraphics(EGraphics.SOLID, EGraphics.PATTERNED, EGraphics.TRANSPARENT_2, 255,155,192,0.8,1,
			new int[] { 0x0808,   //     X       X   
						0x0404,   //      X       X  
						0x0202,   //       X       X 
						0x0101,   //        X       X
		...
		Layer sActive_lay = Layer.newInstance(this, "S-Active",
			new EGraphics(EGraphics.SOLID, EGraphics.PATTERNED, EGraphics.TRANSPARENT_3, 107,226,96,0.8,1,
			new int[] { 0x0000,   //                 
						0x0303,   //       XX      XX
						0x4848,   //  X  X    X  X   
						0x0303,   //       XX      XX
		...
		Layer select_lay = Layer.newInstance(this, "Select",
			new EGraphics(EGraphics.PATTERNED, EGraphics.PATTERNED, 0, 255,255,0,0.8,1,
			new int[] { 0x1010,   //    X       X    
						0x2020,   //   X       X     
						0x4040,   //  X       X      
						0x8080,   // X       X       
		...
		Layer well_lay = Layer.newInstance(this, "Well",
			new EGraphics(EGraphics.SOLID, EGraphics.PATTERNED, EGraphics.TRANSPARENT_4, 240,221,181,0.8,1,
			new int[] { 0x0000,   //                 
						0x00c0,   //         XX      
						0x0000,   //                 
						0x0000,   //                 
		...
		Layer passivation_lay = Layer.newInstance(this, "Passivation",
			new EGraphics(EGraphics.PATTERNED, EGraphics.PATTERNED, 0, 100,100,100,0.8,1,
		...
		Layer pseudoMetal1_lay = Layer.newInstance(this, "Pseudo-Metal-1",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, EGraphics.TRANSPARENT_1, 96,209,255,0.8,1,
			new int[] { 0x2222,   //   X   X   X   X 
						0x0000,   //                 
						0x8888,   // X   X   X   X   
						0x0000,   //                 
		...
		Layer pseudoMetal2_lay = Layer.newInstance(this, "Pseudo-Metal-2",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, EGraphics.TRANSPARENT_5, 224,95,255,0.8,1,
			new int[] { 0x1010,   //    X       X   
						0x2020,   //   X       X    
						0x4040,   //  X       X     
						0x8080,   // X       X      
		...
		Layer pseudoPolysilicon_lay = Layer.newInstance(this, "Pseudo-Polysilicon",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, EGraphics.TRANSPARENT_2, 255,155,192,0.8,1,
			new int[] { 0x0808,   //     X       X   
						0x0404,   //      X       X  
						0x0202,   //       X       X 
						0x0101,   //        X       X
		...
		Layer pseudoSActive_lay = Layer.newInstance(this, "Pseudo-S-Active",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, EGraphics.TRANSPARENT_3, 107,226,96,0.8,1,
			new int[] { 0x0000,   //                 
						0x0303,   //       XX      XX
						0x4848,   //  X  X    X  X   
						0x0303,   //       XX      XX
		...
		Layer pseudoWell_lay = Layer.newInstance(this, "Pseudo-Well",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, EGraphics.TRANSPARENT_4, 240,221,181,0.8,1,
			new int[] { 0x0000,   //                 
						0x00c0,   //         XX      
						0x0000,   //                 
						0x0000,   //                 
		...
		/** Metal-1 arc */
		PrimitiveArc metal1_arc = PrimitiveArc.newInstance(this, "Metal-1", 3, new Technology.ArcLayer []
		{
		...
		/** Metal-2 arc */
		PrimitiveArc metal2_arc = PrimitiveArc.newInstance(this, "Metal-2", 3, new Technology.ArcLayer []
		{
			new Technology.ArcLayer(metal2_lay, 0, Poly.Type.FILLED)
		});
		metal2_arc.setFunction(PrimitiveArc.Function.METAL1);
		...
		polysilicon_arc.setFunction(PrimitiveArc.Function.METAL1);
		...
		/** S-Active arc */
		PrimitiveArc sActive_arc = PrimitiveArc.newInstance(this, "S-Active", 6, new Technology.ArcLayer []
		{
			new Technology.ArcLayer(sActive_lay, 4, Poly.Type.FILLED),
			new Technology.ArcLayer(select_lay, 0, Poly.Type.FILLED)
		});
		sActive_arc.setFunction(PrimitiveArc.Function.DIFFN);
		...
		/** D-Active arc */
		PrimitiveArc dActive_arc = PrimitiveArc.newInstance(this, "D-Active", 10, new Technology.ArcLayer []
		{
			new Technology.ArcLayer(dActive_lay, 8, Poly.Type.FILLED),
			new Technology.ArcLayer(well_lay, 0, Poly.Type.FILLED)
		});
		dActive_arc.setFunction(PrimitiveArc.Function.DIFFP);
		...
		PrimitiveArc substrateActive_arc = PrimitiveArc.newInstance(this, "Substrate-Active", 2, new Technology.ArcLayer []
		{
			new Technology.ArcLayer(dActive_lay, 0, Poly.Type.FILLED),
			new Technology.ArcLayer(sActive_lay, 0, Poly.Type.FILLED)
		});
		substrateActive_arc.setFunction(PrimitiveArc.Function.DIFFS);
		...
		/** Well arc */
		PrimitiveArc wellActive_arc = PrimitiveArc.newInstance(this, "Well-Active", 6, new Technology.ArcLayer []
		{
		...
		wellActive_arc.setFunction(PrimitiveArc.Function.DIFFW);
		...
		/** S-Transistor arc */
		PrimitiveArc sTransistor_arc = PrimitiveArc.newInstance(this, "S-Transistor", 6, new Technology.ArcLayer []
		{
			new Technology.ArcLayer(dActive_lay, 4, Poly.Type.FILLED),
			new Technology.ArcLayer(polysilicon_lay, 4, Poly.Type.FILLED),
			new Technology.ArcLayer(select_lay, 0, Poly.Type.FILLED)
		});
		sTransistor_arc.setFunction(PrimitiveArc.Function.DIFFN);
		...
		/** D-Transistor arc */
		PrimitiveArc dTransistor_arc = PrimitiveArc.newInstance(this, "D-Transistor", 10, new Technology.ArcLayer []
		{
			new Technology.ArcLayer(dActive_lay, 8, Poly.Type.FILLED),
			new Technology.ArcLayer(polysilicon_lay, 8, Poly.Type.FILLED),
			new Technology.ArcLayer(well_lay, 0, Poly.Type.FILLED)
		});
		dTransistor_arc.setFunction(PrimitiveArc.Function.DIFFP);
		...
		polysiliconPin_node.setFunction(NodeProto.Function.PIN);
		...
		sActivePin_node.setFunction(NodeProto.Function.PIN);
		...
		dActivePin_node.setFunction(NodeProto.Function.PIN);
		...
		substrateActivePin_node.setFunction(NodeProto.Function.PIN);
		...
		wellActivePin_node.setFunction(NodeProto.Function.PIN);
		...
		sTransistorPin_node.setFunction(NodeProto.Function.PIN);
		...
		dTransistorPin_node.setFunction(NodeProto.Function.PIN);
		...
		metal1SActiveCon_node.setFunction(NodeProto.Function.CONTACT);
		...
		metal1DActiveCon_node.setFunction(NodeProto.Function.CONTACT);
		...
		metal1PolyCon_node.setFunction(NodeProto.Function.CONTACT);
		...
		metal1Metal2Con_node.setFunction(NodeProto.Function.CONTACT);
		...
		metal1Metal2Con_node.addPrimitivePorts(new PrimitivePort[]
			{
				PrimitivePort.newInstance(this, metal1Metal2Con_node, new ArcProto [] {metal1_arc, wellActive_arc},
					"metal-1-well", 0,180, 0, PortProto.Characteristic.UNKNOWN,
						EdgeH.makeCenter(), EdgeV.makeCenter(), EdgeH.makeCenter(), EdgeV.makeCenter())
			});
		metal1Metal2Con_node.setFunction(NodeProto.Function.WELL);
		metal1Metal2Con_node.setSquare();
		...
		metal1SubstrateCon_node.setFunction(NodeProto.Function.WELL);
		...
		metal1_node.setFunction(NodeProto.Function.NODE);
		...
		metal2_node.setFunction(NodeProto.Function.NODE);
		...
		polysilicon_node.setFunction(NodeProto.Function.NODE);
		...
		active_node.setFunction(NodeProto.Function.NODE);
		...
		select_node.setFunction(NodeProto.Function.NODE);
		...
		cut_node.setFunction(NodeProto.Function.NODE);
		...
		polyCut_node.setFunction(NodeProto.Function.NODE);
		...
		activeCut_node.setFunction(NodeProto.Function.NODE);
		...
		via_node.setFunction(NodeProto.Function.NODE);
		...
		well_node.setFunction(NodeProto.Function.NODE);
		...
		passivation_node.setFunction(NodeProto.Function.NODE);
