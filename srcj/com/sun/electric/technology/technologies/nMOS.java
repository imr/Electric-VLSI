...
public class nMOS extends Technology
{
	...
	private nMOS()
	{
		...
		Layer M_lay = Layer.newInstance(this, "Metal",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, EGraphics.TRANSPARENT_1, 70,250,70,0.8,true,
			new int[] { 0x0000,   //                 
						0x0000,   //                 
						0x2222,   //   X   X   X   X 
						0x8888,   // X   X   X   X   
		...
		Layer P_lay = Layer.newInstance(this, "Polysilicon",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, EGraphics.TRANSPARENT_2, 250,250,0,0.8,true,
		...
		Layer D_lay = Layer.newInstance(this, "Diffusion",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, EGraphics.TRANSPARENT_3, 180,180,180,0.8,true,
		...
		Layer LI_lay = Layer.newInstance(this, "Light-Implant",
			new EGraphics(EGraphics.SOLID, EGraphics.SOLID, 0, 150,90,0,0.8,true,
			new int[] { 0x0000,   //                 
						0xcccc,   // XX  XX  XX  XX  
						0x0000,   //                 
						0xcccc,   // XX  XX  XX  XX  
		...
		t_node.addPrimitivePorts(new PrimitivePort[]
			{
				...
				PrimitivePort.newInstance(this, t_node, new ArcProto [] {Diffusion_arc}, "trans-diff-top", 90,85, 0, PortProto.Characteristic.UNKNOWN,
					EdgeH.fromLeft(3), EdgeV.fromTop(1), EdgeH.fromRight(3), EdgeV.fromTop(1)),
		...
		it_node.addPrimitivePorts(new PrimitivePort[]
			{
				PrimitivePort.newInstance(this, it_node, new ArcProto [] {Polysilicon_arc}, "imp-trans-poly-left", 180,85, 0, PortProto.Characteristic.UNKNOWN,
					EdgeH.fromLeft(1), EdgeV.fromBottom(3), EdgeH.fromLeft(1), EdgeV.fromTop(3)),
				PrimitivePort.newInstance(this, it_node, new ArcProto [] {Diffusion_arc}, "imp-trans-diff-top", 90,85, 2, PortProto.Characteristic.UNKNOWN,
					EdgeH.fromLeft(3), EdgeV.fromTop(1), EdgeH.fromRight(3), EdgeV.fromTop(1)),
