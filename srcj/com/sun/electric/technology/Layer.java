...
//    /** Describes a pseudo layer. */												private static final int PSEUDO =       010000;
	...
	public static enum Function
	{
        ...
        /** Describes a dummy polysilicon layer 1 */            DMYPOLY1  ("dmy-poly-1",  0, 0, 0, POLY1.getHeight(), 0),
        /** Describes a dummy polysilicon layer 2 */            DMYPOLY2  ("dmy-poly-2",  0, 0, 0, POLY2.getHeight(), 0),
        /** Describes a dummy polysilicon layer 3 */            DMYPOLY3  ("dmy-poly-3",  0, 0, 0, POLY3.getHeight(), 0),
        /** Describes a dummy diffusion layer */                DMYDIFF   ("dmy-diffusion", 0, 0, 0, DIFF.getHeight(), 0),
        /** Describes a dummy metal layer 1 */                  DMYMETAL1 ("dmy-metal-1", 1, 0, 0, METAL1.getHeight(), 0),
        /** Describes a dummy metal layer 2 */                  DMYMETAL2 ("dmy-metal-2", 2, 0, 0, METAL2.getHeight(), 0),
        /** Describes a dummy metal layer 3 */                  DMYMETAL3 ("dmy-metal-3", 3, 0, 0, METAL3.getHeight(), 0),
        /** Describes a dummy metal layer 4 */                  DMYMETAL4 ("dmy-metal-4", 4, 0, 0, METAL4.getHeight(), 0),
        /** Describes a dummy metal layer 5 */                  DMYMETAL5 ("dmy-metal-5", 5, 0, 0, METAL5.getHeight(), 0),
        /** Describes a dummy metal layer 6 */                  DMYMETAL6 ("dmy-metal-6", 6, 0, 0, METAL6.getHeight(), 0),
        /** Describes a dummy metal layer 7 */                  DMYMETAL7 ("dmy-metal-7", 7, 0, 0, METAL7.getHeight(), 0),
        /** Describes a dummy metal layer 8 */                  DMYMETAL8 ("dmy-metal-8", 8, 0, 0, METAL8.getHeight(), 0),
        /** Describes a dummy metal layer 9 */                  DMYMETAL9 ("dmy-metal-9", 9, 0, 0, METAL9.getHeight(), 0),
        /** Describes a dummy metal layer 10 */                 DMYMETAL10 ("dmy-metal-10", 10, 0, 0, METAL10.getHeight(), 0),
        /** Describes a dummy metal layer 11 */                 DMYMETAL11 ("dmy-metal-11", 11, 0, 0, METAL11.getHeight(), 0),
        /** Describes a dummy metal layer 12 */                 DMYMETAL12 ("dmy-metal-12", 12, 0, 0, METAL12.getHeight(), 0),
        /** Describes a exclusion polysilicon layer 1 */        DEXCLPOLY1  ("dexcl-poly-1",  0, 0, 0, POLY1.getHeight(), 0),
        /** Describes a exclusion polysilicon layer 2 */        DEXCLPOLY2  ("dexcl-poly-2",  0, 0, 0, POLY2.getHeight(), 0),
        /** Describes a exclusion polysilicon layer 3 */        DEXCLPOLY3  ("dexcl-poly-3",  0, 0, 0, POLY3.getHeight(), 0),
        /** Describes a exclusion diffusion layer */            DEXCLDIFF   ("dexcl-diffusion", 0, 0, 0, DIFF.getHeight(), 0),
        /** Describes a exclusion metal layer 1 */              DEXCLMETAL1 ("dexcl-metal-1", 1, 0, 0, METAL1.getHeight(), 0),
        /** Describes a exclusion metal layer 2 */              DEXCLMETAL2 ("dexcl-metal-2", 2, 0, 0, METAL2.getHeight(), 0),
        /** Describes a exclusion metal layer 3 */              DEXCLMETAL3 ("dexcl-metal-3", 3, 0, 0, METAL3.getHeight(), 0),
        /** Describes a exclusion metal layer 4 */              DEXCLMETAL4 ("dexcl-metal-4", 4, 0, 0, METAL4.getHeight(), 0),
        /** Describes a exclusion metal layer 5 */              DEXCLMETAL5 ("dexcl-metal-5", 5, 0, 0, METAL5.getHeight(), 0),
        /** Describes a exclusion metal layer 6 */              DEXCLMETAL6 ("dexcl-metal-6", 6, 0, 0, METAL6.getHeight(), 0),
        /** Describes a exclusion metal layer 7 */              DEXCLMETAL7 ("dexcl-metal-7", 7, 0, 0, METAL7.getHeight(), 0),
        /** Describes a exclusion metal layer 8 */              DEXCLMETAL8 ("dexcl-metal-8", 8, 0, 0, METAL8.getHeight(), 0),
        /** Describes a exclusion metal layer 9 */              DEXCLMETAL9 ("dexcl-metal-9", 9, 0, 0, METAL9.getHeight(), 0),
        /** Describes a exclusion metal layer 10 */             DEXCLMETAL10 ("dexcl-metal-10", 10, 0, 0, METAL10.getHeight(), 0),
        /** Describes a exclusion metal layer 11 */             DEXCLMETAL11 ("dexcl-metal-11", 11, 0, 0, METAL11.getHeight(), 0),
        /** Describes a exclusion metal layer 12 */             DEXCLMETAL12 ("dexcl-metal-12", 12, 0, 0, METAL12.getHeight(), 0);
